    ...
    <ThemeProvider theme={theme}>
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/customsoftware" component={TempCustomSoftwarePage}></Route>
          <Route exact path="/mobileapps" component={TempMobileAppsPage}></Route>
          <Route exact path="/websites" component={TempWebsitesPage}></Route>
          <Route exact path="/revolution" component={TempRevolutionPage}></Route>
          <Route exact path="/about" component={TempAboutPage}></Route>
          <Route exact path="/contact" component={TempContactPage}></Route>
          <Route exact path="/estimate" component={TempFreeEstimatestPage}></Route>
        </Switch>
        <Footer />
      </BrowserRouter>
    </ThemeProvider>
